class Admin::SettingsController < Admin::ApplicationController
  ...
  def create
    ...
    if @setting.save
      redirect_to edit_admin_setting_url(@setting), notice: 'Succesfully created setting'
    else
  ...
  def update
    ...
    if @setting.update(settings_params)
      redirect_to edit_admin_setting_url(@setting), notice: 'Succesfully updated setting'
    else
